...
import loginBg from '../../assets/mha-health-networking.jpg';
...
const LoginForm = () => {
  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center bg-black/40 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-6 bg-white p-10 rounded-2xl shadow-2xl">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Accede a tu cuenta de Quantum Medical
            </p>
          </div>
